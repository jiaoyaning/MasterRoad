...
[锁相关-Lock & Synchronized & Volatile & AQS](app/src/main/java/com/jyn/masterroad/concurrent/lock/锁相关.md)  
[类的初始化与实例化](java_kotlin/src/main/java/com/jyn/java_kotlin/Java学习/Java类初始化和对象实例化/类的初始化与实例化.md)    
[java基础](java_kotlin/src/main/java/com/jyn/java_kotlin/Java基础.md)  
[网络协议相关](blogs/各种网络协议.md)  
[Java就是值传递](java_kotlin/src/main/java/com/jyn/java_kotlin/Java学习/Java值传递和拷贝/Java就是值传递.md)  
[深拷贝与浅拷贝](java_kotlin/src/main/java/com/jyn/java_kotlin/Java学习/Java值传递和拷贝/深拷贝与浅拷贝.md)  
[JVM](blogs/JVM.md)
...
[版本适配 & Gradle中的Version](blogs/版本问题和Gradle_Version.md)  
[序列化Serializable 和 Parcelable](app/src/main/java/com/jyn/masterroad/base/serialize/序列化.md)   
[启动流程和插件化](blogs/启动流程和插件化.md)  
[布局流程](app/src/main/java/com/jyn/masterroad/view/layout/布局流程.md)  
[UI绘制](app/src/main/java/com/jyn/masterroad/view/draw/绘制.md)  
[优化](blogs/优化.md)

[Rxjava](app/src/main/java/com/jyn/masterroad/utils/rxjava/Rxjava.md)
[OkHttp](app/src/main/java/com/jyn/masterroad/utils/okhttp/OkHttp.md)
[IO和NIO和Okio](app/src/main/java/com/jyn/masterroad/utils/okio/IO和NIO和Okio.md)

# 测试

[Junit](app/src/androidTest/java/com/jyn/masterroad/blogs/Junit.md)  
[Espresso & UiAutomator & mockito](app/src/androidTest/java/com/jyn/masterroad/blogs/README.md)  
